...
const pages = [['Home','/'], [`${user.role == 'requester'? 'Booking':'Dashboard' }`,`${user.role == 'requester'? '/booking':'/dashboard' }`], ['Hotels','/hotels'], ['About Us','/about'], ['Contact Us','/contact']];
      ...
      <Container maxWidth="xl"  >
        <Toolbar disableGutters >
          ...
          <IconButton
            ...
            <Badge color="secondary" variant="dot"  sx={{ margin:'0 20px'}} invisible={invisible}>
